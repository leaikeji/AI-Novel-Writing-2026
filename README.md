...
AI小说世界2026 是运行在 QwenPaw 2.2.0 中的个人小说写作 PawApp。
...
- 专用“AI小说作家” Agent，以及只在该 Agent 中启用、可持续优化的十一个小说 Skills。
- 五个受范围校验的小说工具；HTTP UI 与工具共用同一领域服务。
