...
case "$AI_NOVEL_MAINTENANCE_STEP" in
    ...
    bootstrap-20260902_0039) expected_alembic_head=20260902_0039 ;;
    bootstrap-20260903_0040) expected_alembic_head=20260903_0040 ;;
    ...
    bootstrap-20260912_0054) expected_alembic_head=20260912_0054 ;;
    bootstrap-20260912_0055) expected_alembic_head=20260912_0055 ;;
