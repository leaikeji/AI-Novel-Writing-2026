...
def test_voice_product_revision_is_followed_by_qwen_mandarin_head() -> None:
    ...
    assert scripts.get_revision("20260902_0038").down_revision == "20260902_0037"
    assert scripts.get_revision("20260902_0037").down_revision == "20260901_0036"
    assert scripts.get_revision("20260901_0036").down_revision == "20260830_0035"
    assert scripts.get_revision("20260830_0035").down_revision == "20260829_0034"
    assert scripts.get_revision("20260829_0034").down_revision == "20260829_0033"
    assert scripts.get_revision("20260829_0033").down_revision == "20260829_0032"
    assert scripts.get_revision("20260829_0032").down_revision == "20260829_0031"
