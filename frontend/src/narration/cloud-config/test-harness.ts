import type { CloudConfigAntdRuntime, CloudConfigReactRuntime } from "./ui-runtime";
...
export const TEST_ANTD: CloudConfigAntdRuntime = {
  Alert: "alert",
  Button: "button",
  Card: "article",
  Checkbox: "checkbox",
...
export function createReactHarness() {
  ...
  const React: CloudConfigReactRuntime = {
