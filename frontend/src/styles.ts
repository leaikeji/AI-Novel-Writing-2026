...
export function ensureNovelStyles(): void {
  ...
  style.textContent = `
    ...
    .anw-editor.has-chapter-tree .anw-editor-topbar { width:min(1440px,calc(100% - 48px)); transform:none; }
    ...
    .anw-editor-topbar {
      display: flex;
      width: min(1440px, calc(100% - 196px));
      align-items: center;
      align-self: center;
      gap: 12px;
      min-height: 64px;
    ...
    .anw-editor-scroll { position:relative; display:grid; width:100%; min-height:auto; grid-template-columns:minmax(0,1440px); align-items:start; justify-content:center; overflow:visible; padding:14px var(--anw-editor-inline-gutter); }
    ...
    .anw-private-library-novel-picker { display:flex; min-width:280px; align-items:center; justify-content:flex-end; gap:10px; color:#707681; font-size:12px; font-weight:700; }
    .anw-private-library-novel-picker .qwenpaw-select { width:220px; }
    .anw-private-library-combinations { margin:14px 0; padding:12px 16px; border:1px solid #eadfce; border-radius:12px; background:#fffdf9; }
    .anw-private-library-combinations > summary { cursor:pointer; font-weight:700; color:#5f4a32; }
    .anw-private-library-combinations > p { margin:10px 0; color:#786b5d; }
    .anw-private-library-combination-list { display:grid; gap:10px; }
    .anw-private-library-combination-list article { display:flex; align-items:center; justify-content:space-between; gap:20px; padding:12px; border:1px solid #eee5da; border-radius:10px; background:#fff; }
    .anw-private-library-combination-list article p { margin:4px 0; color:#6f665d; }
    .anw-private-library-combination-list article small { color:#8c8175; }
    .anw-private-library-combination-preview ul { max-height:280px; overflow:auto; padding-left:22px; }
    .anw-private-library { display:grid; min-width:0; min-height:0; flex:1 1 auto; grid-template-rows:auto auto auto minmax(0,1fr); gap:18px; overflow:hidden; container-type:inline-size; }
    .anw-private-library__header { display:flex; min-width:0; flex-wrap:wrap; align-items:flex-start; justify-content:space-between; gap:20px; }
    .anw-private-library__header > div { min-width:0; flex:1 1 260px; overflow-wrap:anywhere; }
    .anw-private-library__header > button { flex:0 0 auto; }
    .anw-private-library__header h1 { margin:0 0 6px; font-size:28px; }
    .anw-private-library__header p { margin:0; color:var(--anw-muted); font-size:13px; line-height:1.7; }
    .anw-private-library__categories { display:flex; min-width:0; gap:4px; overflow-x:auto; border-bottom:1px solid var(--anw-line); }
    .anw-private-library__categories > button { min-height:42px; flex:0 0 auto; border:0; border-bottom:2px solid transparent; padding:0 15px; color:#707681; background:transparent; cursor:pointer; font:inherit; font-size:13px; font-weight:700; }
    .anw-private-library__categories > button[aria-selected="true"] { border-bottom-color:var(--anw-orange); color:var(--anw-orange-strong); }
    .anw-private-library__categories > button:focus-visible { border-radius:7px 7px 0 0; outline:2px solid rgba(255,112,67,.28); outline-offset:-2px; }
    .anw-private-library__filters { display:flex; min-width:0; flex-wrap:wrap; align-items:center; gap:10px; }
    .anw-private-library__filters > .qwenpaw-input-affix-wrapper { min-width:0; max-width:100%; flex:1 1 240px; }
    .anw-private-library__filters > .qwenpaw-select { min-width:0; max-width:100%; flex:1 1 140px; }
    .anw-private-library__filters > label { display:flex; flex:0 0 auto; align-items:center; gap:6px; white-space:nowrap; }
    .anw-private-library__filters > label input { flex:0 0 auto; margin:0; }
    .anw-private-library__desktop-layout { display:grid; min-height:0; grid-template-columns:minmax(280px,34%) minmax(0,1fr); overflow:hidden; border:1px solid var(--anw-line); border-radius:14px; background:#fff; box-shadow:var(--anw-shadow-soft); }
    .anw-private-library__master { min-width:0; min-height:0; overflow-x:hidden; overflow-y:auto; overscroll-behavior:contain; scrollbar-gutter:stable; border-right:1px solid var(--anw-line); padding:12px; background:#fafbfc; }
    .anw-private-library__asset-list { display:grid; gap:9px; }
    .anw-private-library__asset-card.qwenpaw-card { border-color:#e8eaee; border-radius:10px; box-shadow:none; }
    .anw-private-library__asset-card.is-selected.qwenpaw-card { border-color:#ff9d7c; background:#fff8f4; box-shadow:0 0 0 2px rgba(255,112,67,.09); }
    .anw-private-library__asset-card .qwenpaw-card-body { display:grid; gap:9px; padding:11px; }
    .anw-private-library__asset-select { display:grid; min-width:0; gap:5px; border:0; padding:0; color:inherit; background:transparent; cursor:pointer; text-align:left; }
    .anw-private-library__asset-select strong,.anw-private-library__asset-select span { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
    .anw-private-library__asset-select strong { color:#30343a; font-size:14px; }
    .anw-private-library__asset-select span { color:#888e97; font-size:12px; }
    .anw-private-library__asset-select:focus-visible { border-radius:5px; outline:2px solid rgba(255,112,67,.35); outline-offset:3px; }
    .anw-private-library__asset-meta { display:flex; min-width:0; flex-wrap:wrap; align-items:center; gap:5px; color:#9a9ea5; font-size:10px; }
    .anw-private-library__detail-pane { min-width:0; min-height:0; overflow-x:hidden; overflow-y:auto; overscroll-behavior:contain; scrollbar-gutter:stable; padding:24px; }
    .anw-private-library__detail { display:grid; min-width:0; gap:22px; overflow-wrap:anywhere; }
    .anw-private-library__detail-header { display:flex; min-width:0; flex-wrap:wrap; align-items:flex-start; justify-content:space-between; gap:18px; border-bottom:1px solid var(--anw-line); padding-bottom:18px; }
    .anw-private-library__detail-header > div:first-child { min-width:0; flex:1 1 220px; }
    .anw-private-library__detail-header h2 { margin:0 0 5px; font-size:21px; }
    .anw-private-library__detail-header p,.anw-private-library__summary { margin:0; color:#858b94; font-size:12px; line-height:1.7; }
    .anw-private-library__detail-actions { display:flex; min-width:0; max-width:100%; flex:0 1 auto; flex-wrap:wrap; align-items:center; gap:12px; }
    .anw-private-library__detail-actions > label { display:flex; flex:0 0 auto; align-items:center; gap:7px; color:#696f78; font-size:12px; white-space:nowrap; }
    .anw-private-library__detail-actions > button { flex:0 0 auto; }
    .anw-private-library__entries,.anw-private-library__check { display:grid; gap:12px; }
    .anw-private-library__history { display:grid; gap:10px; border-top:1px solid var(--anw-line); padding-top:16px; }
    .anw-private-library__history h3 { margin:0; font-size:16px; }
    .anw-private-library__history > p { margin:0; color:#858b94; }
    .anw-private-library__history ol { display:grid; gap:7px; margin:0; padding:0; list-style:none; }
    .anw-private-library__history li { display:flex; min-width:0; flex-wrap:wrap; align-items:center; justify-content:space-between; gap:10px; border:1px solid #eceef1; border-radius:8px; padding:8px 10px; }
    .anw-private-library__history li > span:first-child { min-width:0; flex:1 1 180px; }
    .anw-private-library__section-title { display:flex; flex-wrap:wrap; align-items:center; justify-content:space-between; gap:12px; }
    .anw-private-library__section-title h3,.anw-private-library__check h3 { margin:0; font-size:16px; }
    .anw-private-library__entry-list,.anw-private-library__hit-list { display:grid; gap:8px; margin:0; padding:0; list-style:none; }
    .anw-private-library__entry-list > li,.anw-private-library__hit-list > li { display:flex; min-width:0; flex-wrap:wrap; align-items:center; justify-content:space-between; gap:12px; border:1px solid #eceef1; border-radius:9px; padding:10px 12px; background:#fff; }
    .anw-private-library__entry-list > li > div,.anw-private-library__hit-list > li > div { display:flex; min-width:0; flex:1 1 200px; flex-wrap:wrap; align-items:center; gap:7px; }
    .anw-private-library__entry-list p { flex:1 1 100%; margin:4px 0 0; color:#777d86; font-size:12px; line-height:1.6; }
    .anw-private-library__loading,.anw-private-library__empty,.anw-private-library__detail-empty { display:flex; min-height:280px; align-items:center; justify-content:center; gap:10px; color:#8a9099; text-align:center; }
    .anw-private-library__editor-fields { display:grid; gap:16px; padding-top:12px; }
    .anw-private-library__editor-fields > label { display:grid; gap:7px; color:#4c5159; font-size:12px; font-weight:700; }
    .anw-private-library__editor-fields > label:has(.qwenpaw-switch) { display:flex; align-items:center; }
    .anw-private-library__drawer-footer { display:flex; justify-content:flex-end; gap:9px; }
    /* The host sidebar and assistant can narrow this desktop page independently
       of the window. Keep this query anonymous for the inline CSS compactor. */
    @container (max-width:760px) {
      .anw-private-library__desktop-layout { min-height:0; grid-template-columns:minmax(0,1fr); grid-template-rows:minmax(160px,35%) minmax(0,1fr); }
      .anw-private-library__master { max-height:320px; border-right:0; border-bottom:1px solid var(--anw-line); }
      .anw-private-library__detail-pane { padding:18px; }
    }
    .anw-private-library-capture.qwenpaw-card { width:min(460px,calc(100vw - 24px)); max-height:min(72vh,620px); overflow:auto; border:0; border-top:1px solid #f0f1f3; border-radius:0; box-shadow:none; }
    .anw-private-library-capture .qwenpaw-card-body { display:grid; gap:11px; padding:12px; }
    .anw-private-library-capture label { display:grid; gap:5px; color:#555b64; font-size:11px; font-weight:700; }
    .anw-private-library-capture__destination { margin:0; border-radius:8px; padding:8px 10px; color:#6a625c; background:#fff7f2; font-size:11px; line-height:1.55; }
    .anw-private-library-capture__actions { display:flex; justify-content:flex-end; gap:8px; }
    .anw-library-check-hit-list { display:grid; gap:10px; max-height:420px; overflow:auto; padding-left:24px; }
    .anw-library-check-hit-list li { padding:8px 10px; border:1px solid #eee6dc; border-radius:8px; }
    .anw-library-check-hit-list li > div { display:flex; align-items:center; gap:8px; flex-wrap:wrap; }
    .anw-library-check-summary { display:grid; gap:10px; color:#555b64; line-height:1.7; }
    .anw-library-check-summary p { margin:0; }
    ...
    .anw-selection-edit-review { display:grid; width:100%; min-width:0; align-content:start; overflow:visible; border:0; border-radius:0; color:#34383f; background:#fff; box-shadow:none; }
    .anw-selection-edit-review > header { grid-row:2; display:grid; gap:5px; border-bottom:1px solid #eceef1; padding:11px 16px 12px; background:#fafbfc; }
    .anw-selection-edit-review h2 { margin:0!important; color:#24282f!important; font-size:15px; font-weight:760; line-height:1.35; }
    .anw-selection-edit-review > header > p { margin:0; color:#858a92; font-size:11px; line-height:1.55; }
    .anw-selection-edit-review-toolbar { position:sticky; z-index:5; top:0; grid-row:1; display:flex; min-height:56px; flex-wrap:nowrap; align-items:center; gap:8px; overflow-x:auto; border-bottom:1px solid #e9ebee; padding:9px 14px; background:rgba(255,255,255,.98); box-shadow:none; backdrop-filter:blur(10px); scrollbar-width:thin; }
    .anw-selection-edit-review-toolbar-summary { display:flex; min-width:max-content; align-items:center; gap:12px; margin-right:auto; }
    .anw-selection-edit-review-change-count { color:#ff6738; font-size:12px; font-weight:760; white-space:nowrap; }
    .anw-selection-edit-review button { min-height:34px; border:1px solid #dfe2e6; border-radius:7px; padding:0 12px; color:#565c65; background:#fff; cursor:pointer; font:inherit; font-size:12px; font-weight:720; white-space:nowrap; transition:border-color .15s ease,color .15s ease,background .15s ease,box-shadow .15s ease; }
    ...
    .anw-selection-edit-review-toolbar > button:nth-last-child(2) { border-color:#ff7043; color:#fff; background:#ff7043; box-shadow:0 4px 11px rgba(255,112,67,.18); }
    ...
    .anw-selection-edit-review-context { display:block; padding:13px 16px; color:#3d424a; font-size:14px; line-height:1.95; white-space:pre-wrap; }
    .anw-selection-edit-review-change { display:grid; grid-template-columns:minmax(0,1fr) auto; border-block:1px solid #ebecef; background:#fff; scroll-margin-top:64px; }
    .anw-selection-edit-review-change + .anw-selection-edit-review-change { border-top:0; }
    .anw-selection-edit-review-change:focus { outline:0; }
    .anw-selection-edit-review-change:focus-visible { outline:2px solid rgba(255,112,67,.48); outline-offset:-2px; }
    .anw-selection-edit-review-change.is-current { position:relative; box-shadow:inset 3px 0 #ff7548; }
    .anw-selection-edit-review-change-lines { display:grid; min-width:0; grid-column:1; }
    .anw-selection-edit-review-line { display:grid; min-height:48px; grid-template-columns:18px 48px minmax(0,1fr); align-items:start; gap:7px; padding:10px 14px; font-size:14px; line-height:1.9; white-space:pre-wrap; }
    ...
    .anw-selection-edit-review-result { color:#34735a; background:#f4fbf7; }
    .anw-selection-edit-review-line > span:first-child { font-size:17px; font-weight:850; line-height:1.55; }
    .anw-selection-edit-review-line > strong { font-size:11px; font-weight:800; line-height:2.55; }
    .anw-selection-edit-review-inline-actions { display:flex; min-width:88px; grid-column:2; grid-row:1; align-items:center; justify-content:center; gap:8px; border-left:1px solid rgba(0,0,0,.045); padding:8px 13px; background:#fff; }
    .anw-selection-edit-review-inline-actions > button { min-height:30px; border:0; padding:0 2px; color:#5e776c; background:transparent; box-shadow:none; }
    .anw-selection-edit-review-inline-actions > button:last-child { color:#9b5d57; }
    .anw-selection-edit-review-inline-actions > button:hover,.anw-selection-edit-review-inline-actions > button:focus-visible { border:0; background:transparent; box-shadow:none; text-decoration:underline; text-underline-offset:3px; }
    .anw-selection-edit-review-inline-actions button[aria-pressed="true"] { border:0; color:#fff; border-radius:6px; padding:0 8px; background:#ff7043; text-decoration:none; }
    .anw-selection-edit-review-change.is-accept { box-shadow:inset 3px 0 #2e9f6d; }
    .anw-selection-edit-review-change.is-reject { opacity:.68; box-shadow:inset 3px 0 #9ba0a8; }
    .anw-selection-edit-review-decision-label { margin:0; color:#737981; font-size:11px; text-align:center; }
    .anw-selection-edit-review-empty-result { margin:0; font-size:12px; }
    .anw-selection-edit-review-footer { position:sticky; z-index:4; bottom:0; grid-row:4; display:flex; min-height:38px; align-items:center; justify-content:flex-end; gap:20px; border-top:1px solid #e8eaed; padding:7px 14px; color:#878c94; background:rgba(255,255,255,.98); font-size:11px; backdrop-filter:blur(10px); }
    ...
    .anw-selection-edit-review.is-compact { border:1px solid #e7e9ed; border-radius:10px; }
    .anw-selection-edit-review.is-compact .anw-selection-edit-review-toolbar { position:static; min-height:auto; flex-wrap:wrap; overflow:visible; padding:9px 12px; }
    .anw-selection-edit-review.is-compact .anw-selection-edit-review-toolbar-summary { width:100%; flex:1 0 100%; margin-right:0; }
    .anw-selection-edit-review.is-compact .anw-selection-edit-review-toolbar > button { min-width:0; flex:1 1 auto; padding-inline:8px; }
    .anw-selection-edit-review.is-compact .anw-selection-edit-review-context { padding:11px 14px; font-size:13px; }
    .anw-selection-edit-review.is-compact .anw-selection-edit-review-line { min-height:44px; padding:9px 12px; font-size:13px; }
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing),
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) { display:grid; min-height:calc(100vh - 74px); grid-template-columns:minmax(0,1fr); align-content:start; overflow:clip; border:0; border-radius:0; padding:0; background:#fff; box-shadow:none; }
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-title-row,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-title-row { grid-row:2; padding:20px 24px 18px; }
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-title-row > .anw-editor-title-actions,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-title-row > .anw-editor-title-actions { display:none; }
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-footer,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-footer { display:none; }
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-selection-review-host,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-selection-review-host,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-selection-review-host > .anw-selection-edit-review,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-selection-review-host > .anw-selection-edit-review { display:contents; }
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-title-row,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-title-row,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-toolbar,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-toolbar,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-diff,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-diff,
    ...
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-footer { grid-column:1 / -1; min-width:0; }
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-toolbar,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-toolbar { grid-row:1; }
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-header,
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-applying) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-header { display:none; }
    .anw-editor-paper:has(.anw-editor-selection-review-host .anw-selection-edit-review.is-reviewing) > .anw-editor-selection-review-host > .anw-selection-edit-review > .anw-selection-edit-review-diff,
    ...
    .anw-intelligence-groups article { display:grid; gap:12px; border:1px solid #eceef2; border-left:3px solid #ff8b63; border-radius:9px; padding:16px 18px; background:#f8f8f9; transition:border-color .16s ease,background .16s ease,box-shadow .16s ease; }
    .anw-intelligence-groups article.is-selected { border-color:#ff9a76; background:#fff8f5; box-shadow:0 0 0 2px rgba(255,117,72,.09); }
    .anw-intelligence-groups article.is-accepted { border-left-color:#52c41a; background:#f6fff2; }
    .anw-intelligence-groups article.is-rejected { border-left-color:#ff4d4f; background:#fff5f5; }
    .anw-intelligence-choice { display:flex; align-items:flex-start; gap:11px; cursor:pointer; }
    .anw-intelligence-choice > span:last-child { display:flex; flex:1; min-width:0; align-items:center; gap:9px; }
    .anw-intelligence-choice strong { color:#30343a; font-size:15px; }
    .anw-intelligence-change,.anw-intelligence-relationship { display:grid; grid-template-columns:1fr 1fr; gap:12px 24px; color:#555a61; line-height:1.65; }
    .anw-intelligence-relationship { border-radius:8px; padding:11px 13px; background:#fff; }
    .anw-intelligence-groups blockquote { margin:0; border-left:2px solid #d9dce2; padding-left:12px; color:#686d75; line-height:1.6; }
    .anw-intelligence-groups blockquote small { display:block; margin-bottom:2px; color:#969aa1; }
    ...
    .anw-text-cover::after { position:absolute; right:10%; bottom:9%; left:10%; height:2px; content:""; background:#d9915b; opacity:.85; }
    .anw-text-cover-kicker { position:relative; z-index:1; color:#dbc7b7; font-size:clamp(6px,5cqi,11px); letter-spacing:.18em; }
    .anw-text-cover-title { position:relative; z-index:1; display:-webkit-box; overflow:hidden; color:inherit; font-size:clamp(8px,12cqi,32px); font-weight:750; letter-spacing:.04em; line-height:1.35; overflow-wrap:anywhere; -webkit-box-orient:vertical; -webkit-line-clamp:4; }
    .anw-text-cover-author { position:relative; z-index:1; margin-bottom:9%; color:#f3e8de; font-size:clamp(7px,6cqi,14px); letter-spacing:.08em; }
    ...
    .mb-novel-switcher > button > img,
    .mb-novel-switcher > button > .mb-novel-switch-cover { width:100%; height:100%; object-fit:cover; }
    .mb-novel-switch-cover.anw-text-cover { border-radius:4px; box-shadow:none; }
    ...
    .mb-private-page:has(.anw-private-library) { height:100%; min-height:0; overflow:hidden; padding-bottom:28px; }
    .mb-private-inner { width:min(1180px,100%); margin:0 auto; }
    .mb-private-inner:has(> .anw-private-library) { display:flex; height:100%; min-height:0; flex-direction:column; }
    ...
    .mb-cover-text-preview { width:150px; height:200px; margin:16px auto 0; border-radius:8px; box-shadow:0 7px 18px rgba(30,36,46,.15); }
    ...
    .anw-workbench-frame[data-assistant-density="constrained"] .mb-panel-body.is-chapters { padding:0; }
    .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-master-detail { grid-template-columns:minmax(190px,30%) minmax(0,1fr); }
    .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-volume-pane { padding:18px 14px 22px; }
    .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-detail-header { padding-inline:20px; }
    .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-table { margin:18px 20px; }
    .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-table-head,
    .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-table-row { grid-template-columns:minmax(190px,1fr) minmax(104px,132px) minmax(100px,126px) 36px 36px; column-gap:8px; }
    ...
    .mb-chapter-header-search { width:clamp(180px,17vw,250px); }
    .mb-chapter-header-search .qwenpaw-input-affix-wrapper { min-height:32px; border-color:#e0e2e5!important; border-radius:6px!important; background:#fff!important; box-shadow:none!important; }
    .mb-chapter-header-search .qwenpaw-input-affix-wrapper:hover { border-color:#ff9b77!important; }
    .mb-chapter-header-search .qwenpaw-input-affix-wrapper-focused { border-color:#ff7548!important; box-shadow:0 0 0 2px rgba(255,117,72,.1)!important; }
    .mb-chapter-header-search .qwenpawicon { color:#9a9ea5; }
    .mb-chapter-sort.qwenpaw-btn { min-width:76px; }
    ...
    .mb-panel-body.is-chapters { padding:0; overflow:hidden; }
    ...
    .mb-chapter-dashboard { display:flex; min-width:0; min-height:0; flex:1; }
    .mb-chapter-master-detail { display:grid; width:100%; min-width:0; min-height:0; grid-template-columns:minmax(230px,27%) minmax(0,1fr); }
    .mb-chapter-volume-pane { display:flex; min-width:0; min-height:0; flex-direction:column; border-right:1px solid #eceef1; padding:22px 20px 24px; overflow:hidden; background:#fff; }
    .mb-chapter-volume-heading { display:flex; min-height:38px; align-items:center; justify-content:space-between; gap:12px; margin-bottom:10px; }
    .mb-chapter-volume-heading h3 { margin:0; color:#2f3339; font-size:18px; line-height:1.4; }
    .mb-chapter-volume-heading .mb-inline-add.qwenpaw-btn { height:34px; padding-inline:7px!important; }
    .mb-chapter-volume-list { display:grid; min-height:0; align-content:start; overflow:auto; overscroll-behavior:contain; }
    .mb-volume-zero { min-height:62px; display:grid; place-items:center; border-bottom:1px solid #eff0f2; color:#a1a5ac; font-size:12px; }
    .mb-chapter-volume-item { display:grid; min-width:0; min-height:72px; grid-template-columns:minmax(0,1fr) auto; align-items:center; column-gap:12px; border:0; border-bottom:1px solid #eff0f2; border-left:3px solid transparent; padding:12px 12px 12px 15px; color:#3b3f46; background:#fff; cursor:pointer; text-align:left; transition:border-color .16s ease,background-color .16s ease,color .16s ease; }
    .mb-chapter-volume-item:hover { color:#ef6f45; background:#fffaf7; }
    .mb-chapter-volume-item:focus-visible { position:relative; z-index:1; outline:2px solid #ff9b77; outline-offset:-2px; }
    .mb-chapter-volume-item.is-active { border-left-color:#ff7548; color:#2f3339; background:#fafafa; }
    .mb-chapter-volume-item strong { min-width:0; overflow:hidden; font-size:14px; font-weight:680; text-overflow:ellipsis; white-space:nowrap; }
    .mb-chapter-volume-item span { color:#9a9ea5; font-size:12px; white-space:nowrap; }
    .mb-chapter-volume-item.is-ungrouped { margin-top:8px; border-top:1px solid #eff0f2; }
    .mb-chapter-detail-pane { display:flex; min-width:0; min-height:0; flex-direction:column; overflow:auto; overscroll-behavior:contain; background:#fff; }
    .mb-chapter-detail-header { display:flex; min-height:84px; flex:0 0 auto; align-items:center; justify-content:space-between; gap:18px; border-bottom:1px solid #eceef1; padding:18px 28px; }
    .mb-chapter-detail-header > div { display:flex; min-width:0; align-items:baseline; gap:12px; }
    .mb-chapter-detail-header h3 { min-width:0; margin:0; overflow:hidden; color:#2f3339; font-size:20px; line-height:1.4; text-overflow:ellipsis; white-space:nowrap; }
    .mb-chapter-detail-header span { color:#9a9ea5; font-size:12px; white-space:nowrap; }
    .mb-chapter-volume-more.qwenpaw-btn,.mb-chapter-more.qwenpaw-btn,.mb-chapter-enter.qwenpaw-btn { color:#8b8f96!important; border:0!important; background:transparent!important; box-shadow:none!important; }
    .mb-chapter-volume-more.qwenpaw-btn:hover,.mb-chapter-more.qwenpaw-btn:hover,.mb-chapter-enter.qwenpaw-btn:hover { color:#ef6d42!important; background:#fff4ef!important; }
    .mb-chapter-table { flex:0 0 auto; margin:24px 28px 32px; border:1px solid #e8e9ec; border-radius:7px; overflow:hidden; background:#fff; }
    .mb-chapter-table-head,.mb-chapter-table-row { display:grid; min-width:0; grid-template-columns:minmax(240px,1fr) minmax(120px,160px) minmax(120px,160px) 40px 40px; align-items:center; column-gap:12px; padding:0 18px; }
    .mb-chapter-table-head { min-height:48px; color:#858a92; background:#fafafa; font-size:12px; font-weight:650; }
    .mb-chapter-table-row { min-height:72px; border-top:1px solid #eceef1; color:#3a3e45; }
    .mb-chapter-table-row:hover { background:#fffdfc; }
    .mb-chapter-table-open { display:grid; min-width:0; align-self:stretch; align-content:center; gap:5px; border:0; padding:0; color:#34383e; background:transparent; cursor:pointer; text-align:left; }
    .mb-chapter-table-open:focus-visible { border-radius:5px; outline:2px solid #ff9b77; outline-offset:2px; }
    .mb-chapter-table-open strong { min-width:0; overflow:hidden; font-size:14px; font-weight:680; text-overflow:ellipsis; white-space:nowrap; }
    .mb-chapter-table-open span { color:#a0a4ab; font-size:11px; }
    .mb-chapter-version { width:max-content; max-width:100%; border:1px solid transparent; border-radius:999px; padding:4px 9px; overflow:hidden; font-size:11px; font-weight:650; line-height:1.2; text-overflow:ellipsis; white-space:nowrap; }
    .mb-chapter-version.is-draft { border-color:#e2e4e7; color:#777c84; background:#f7f7f8; }
    .mb-chapter-version.is-saved { border-color:#ffd7c8; color:#d96036; background:#fff5f0; }
    .mb-chapter-version.is-checkpointed { border-color:#ccebdc; color:#31835a; background:#f1fbf6; }
    .mb-chapter-updated { color:#888d95; font-size:12px; font-variant-numeric:tabular-nums; white-space:nowrap; }
    .mb-chapter-more.qwenpaw-btn,.mb-chapter-enter.qwenpaw-btn { width:32px; min-width:32px; height:32px; padding:0!important; }
    .mb-chapter-more-placeholder { width:32px; height:32px; }
    .mb-chapter-detail-empty { display:grid; min-height:220px; place-content:center; justify-items:center; gap:9px; color:#a2a6ad; }
    .mb-chapter-detail-empty > .qwenpawicon { margin-bottom:2px; font-size:28px; }
    .mb-chapter-detail-empty strong { color:#777c84; font-size:14px; font-weight:600; }
    .mb-chapter-detail-empty span { color:#a4a8af; font-size:12px; }
    ...
    .mb-role-overview-metrics strong { color:#343840; font-size:19px; line-height:1.15; }
    .mb-role-section { border:1px solid #efefef; border-radius:12px; padding:20px 20px 24px; background:#fafafa; }
    .mb-role-section.is-supporting { border-color:#eaebf5; background:#fafbff; }
    .mb-role-section .mb-subtitle-row { margin-bottom:16px; }
    .mb-role-section-heading { display:grid; gap:4px; }
    .mb-role-section-heading h3,.mb-role-section-heading p { margin:0; }
    .mb-role-section-heading h3 { display:flex; align-items:center; gap:8px; }
    .mb-role-section-heading h3::before { width:4px; height:20px; border-radius:3px; background:#ff7548; content:""; }
    .mb-role-section.is-supporting .mb-role-section-heading h3::before { background:#5c7cea; }
    .mb-role-section-heading h3 span { display:grid; min-width:22px; height:22px; place-items:center; border-radius:999px; color:#d9633e; background:#fff0ea; font-size:11px; font-weight:700; }
    .mb-role-section.is-supporting .mb-role-section-heading h3 span { color:#526ed2; background:#edf0ff; }
    .mb-role-section-heading p { padding-left:12px; color:#92969e; font-size:11px; }
    ...
    .mb-role-copy { display:flex; width:100%; min-width:0; min-height:100%; flex:1; flex-direction:column; gap:6px; }
    .mb-role-title-line { display:flex; min-width:0; align-items:center; gap:8px; padding-right:24px; }
    .mb-role-title-line strong { overflow:hidden; color:#343840; text-overflow:ellipsis; white-space:nowrap; font-size:16px; }
    .mb-role-title-line>span { flex:0 0 auto; border-radius:999px; padding:2px 7px; color:#dc6842; background:#fff1eb; font-size:10px; font-weight:700; }
    .is-supporting .mb-role-title-line>span { color:#526ed2; background:#eef1ff; }
    .mb-role-copy small { overflow:hidden; color:#747983; text-overflow:ellipsis; white-space:nowrap; font-size:12px; }
    .mb-role-description { display:-webkit-box; min-height:36px; overflow:hidden; color:#989ca4; -webkit-box-orient:vertical; -webkit-line-clamp:2; font-size:11px; line-height:1.65; }
    ...
    .mb-relation-toolbar { position:static; display:flex; min-width:0; align-items:center; flex-wrap:wrap; gap:8px; border:1px solid #e6e8ec; border-radius:10px; padding:9px 10px; background:rgba(255,255,255,.97); box-shadow:0 5px 18px rgba(35,41,51,.06); backdrop-filter:blur(10px); }
    .mb-relation-filter-tools { display:grid; min-width:0; flex:1 1 560px; grid-template-columns:minmax(220px,1fr) minmax(120px,148px) minmax(120px,148px); gap:8px; }
    .mb-relation-toolbar .qwenpaw-select { width:100%; min-width:0; }
    .mb-relation-toolbar .mb-relation-character-search { width:100%; }
    .mb-relation-edit-tools { display:flex; min-width:0; flex:0 0 auto; align-items:center; gap:8px; margin-left:auto; }
    ...
    .mb-cover-edit-modes { display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:10px; }
    ...
    .mb-cover-edit-text-preview { width:150px; height:200px; border-radius:8px; box-shadow:0 7px 18px rgba(30,36,46,.15); }
    ...
    @media (max-width: 980px) {
      ...
      .mb-role-overview { align-items:flex-start; }
      .mb-role-overview-metrics { display:grid; grid-template-columns:repeat(3,1fr); }
      .mb-role-overview-metrics>span { min-width:58px; }
    }
    ...
    @media (max-width: 720px) {
      ...
      .mb-role-section .mb-subtitle-row { align-items:flex-start; }
      .mb-role-section-heading p { display:none; }
      .mb-role-grid { grid-template-columns:1fr; }
      .mb-role-card { min-height:154px; padding:14px; }
      .mb-role-card > .qwenpaw-btn { opacity:1; }
      ...
      .mb-book-rail > h1 { margin:2px 0 4px; font-size:18px; }
      .mb-book-rail > p { min-height:0; max-height:38px; margin:0; }
      .mb-book-stats { margin:4px 0 10px; }
      .anw-current-model-card { grid-column:1/-1; margin:8px 0 0; }
      .mb-book-nav {
        position:sticky;
        z-index:8;
        top:0;
      ...
      .mb-book-nav > button.is-active {
        outline:0;
        border-bottom:2px solid #ff7548;
        background:#fff;
      }
      .mb-back-center-wrap { grid-column:1/-1; margin:10px 0 0; padding:0 0 12px; }
      .mb-workbench-main { width:100%; border:0; border-radius:0; overflow:visible; box-shadow:none; }
      .mb-panel-header,
      .anw-workbench-frame[data-assistant-density="constrained"] .mb-panel-header { min-height:64px; padding:14px 16px; }
      ...
      .mb-panel-body.is-chapters,
      .anw-workbench-frame[data-assistant-density="constrained"] .mb-panel-body.is-chapters { padding:0; overflow:visible; }
      .mb-panel-actions { gap:6px; }
      .mb-chapter-header-search { display:none; }
      .mb-chapter-sort.qwenpaw-btn { min-width:40px; padding-inline:8px!important; }
      .mb-chapter-sort.qwenpaw-btn > span:not(.qwenpaw-btn-icon) { display:none; }
      .mb-chapter-dashboard { display:block; }
      .mb-chapter-master-detail,
      .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-master-detail { display:block; }
      .mb-chapter-volume-pane,
      .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-volume-pane { border-right:0; border-bottom:1px solid #eceef1; padding:16px 14px 18px; overflow:visible; }
      .mb-chapter-volume-list { grid-template-columns:repeat(2,minmax(0,1fr)); gap:6px; overflow:visible; }
      .mb-volume-zero { grid-column:1/-1; }
      .mb-chapter-volume-item { min-height:58px; border:1px solid #eff0f2; border-left-width:3px; border-radius:6px; padding:10px 10px 10px 12px; }
      .mb-chapter-volume-item.is-ungrouped { margin-top:0; border-top-color:#eff0f2; }
      .mb-chapter-detail-pane { overflow:visible; }
      .mb-chapter-detail-header,
      .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-detail-header { min-height:68px; padding:14px 16px; }
      .mb-chapter-table,
      .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-table { margin:14px; overflow-x:auto; }
      .mb-chapter-table-head,.mb-chapter-table-row,
      .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-table-head,
      .anw-workbench-frame[data-assistant-density="constrained"] .mb-chapter-table-row { min-width:650px; grid-template-columns:minmax(230px,1fr) 120px 120px 36px 36px; }
      ...
      .mb-relation-filter-tools { flex-basis:100%; grid-template-columns:1fr; }
