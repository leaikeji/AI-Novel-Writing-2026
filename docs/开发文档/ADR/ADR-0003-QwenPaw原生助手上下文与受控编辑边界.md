...
状态：已接受；阶段 1–7 历史施工继续以本文为准。2026-08-25 起，决策 6 中“Clipboard 默认交接、聊天内完整候选卡片和卡片主审阅动作”由 [ADR-0004](./ADR-0004-选区AI编辑任务与中央统一Diff审阅.md)替代；其余上下文、留存、Adapter、CAS、撤销、工具与 Agent 边界继续有效。
