...
日期：2026-09-13。状态：`6837e1b RELEASED / F21历史计数修复 / 完整2K候选截图PASS / G3 OPEN`。作者全权授权已明确，必要依赖来源由主代理协调，不再重复索要。23:03只增加Edge正式截图与只读状态证据，不改变发布源。下文早期HOLD／未提交状态保留历史证明力，最新来源如下及[formal-release.md](formal-release.md)。

## 最新可复核来源

- 23:03正式运行仍为6837e1b。独立Edge实际CSS／DOM及JPEG均2560×1440，[历史](desktop/51-edge-history-2560x1440.jpg)和[候选逐项检查](desktop/52-candidate-preview-edge-2560x1440.jpg)关闭此前内嵌捕获限制；[当前模型](edge-2k-model-after.json)只读为bigmodel/glm-5.3-flash，[当前库](edge-2k-catalog-current.json)仍total13。正文、jobs和bindings与F21证据精确相同，无运行写入。该证据提交不重新打包或部署。
- F21源码`6837e1be0e0ed1516e04b1c2ba5b302a5053d327`，tree `4759634dbde21c2c1e40d7673f40c209335f7828`。两个前端文件精确提交，干净源1560项／类型／构建／打包通过；22:47公开更新唯一JS变化，SHA `d2876aa5d14505d24589e846874f8f79c00f36f0e34c8de312c0c1cfe542f5aa`。备份、配置保持与正式历史见[完整记录](history-count-release.md)及[来源清单](history-count-release-manifest.json)。此前候选桌面证据3008f63已实际push；本轮源码与证据随收口精确push，不夹带其他计划。
