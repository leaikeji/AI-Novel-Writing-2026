...
日期：2026-09-13。最新正式源：`6837e1b RELEASED / F21历史计数修复 / G3 PARTIAL`，保留15f4f5f全部功能。22:47公开热更新、备份／保态／健康及真实历史复验通过，无重启、迁移或模型调用，详见[F21发布与恢复](history-count-release.md)。下文旧HOLD记录是当时执行事实，不再构成再次索要作者授权的依据。
