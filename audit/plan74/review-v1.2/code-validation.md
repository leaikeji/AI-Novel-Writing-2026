...
日期：2026-09-13。状态：`6837e1b G2-B PASS / F21已公开更新 / G3 PARTIAL`。新增历史总数／待处理数区分，红测3项失败后定向35／全量1560／类型／构建／打包通过，见[F21代码及正式记录](history-count-release.md)。下方旧代码检查及HOLD保留历史，正式分项不等于G3整体通过。
